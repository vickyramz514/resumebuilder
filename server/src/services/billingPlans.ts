...
export const defaultBillingPlans: Prisma.SubscriptionPlanCreateInput[] = [
  {
    ...
    billingCycle: null,
    razorpayPlanId: null,
    features: ['9 free templates', 'Cloud resume library', 'Manual editing'] as Prisma.InputJsonValue,
    isActive: true,
    adminOnly: false,
    sortOrder: 0,
  ...
  },
  {
    ...
    features: ['Everything in Free', '11 Pro templates', 'PDF and Word export', 'Gemini AI assistant', 'Job-description tailoring'] as Prisma.InputJsonValue,
    isActive: true,
    adminOnly: false,
    sortOrder: 1,
