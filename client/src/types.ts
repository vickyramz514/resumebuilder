...
export type TemplateId = 'minimal' | 'professional' | 'modern' | 'editorial' | 'creative' | 'compact' | 'classic' | 'executive' | 'technical' | 'academic' | 'swiss' | 'folio' | 'harbor' | 'lumen' | 'chronicle' | 'velvet';
