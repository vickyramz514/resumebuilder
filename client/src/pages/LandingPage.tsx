...
const FALLBACK_PRICING: Pick<SubscriptionPlan, 'slug' | 'name' | 'priceCents' | 'currency' | 'billingCycle' | 'description'>[] = [
  { slug: 'free', name: 'Free', priceCents: 0, currency: 'INR', billingCycle: null, description: '11 templates, cloud library, and the editor. No card required.' },
  { slug: 'starter', name: 'Starter', priceCents: 65000, currency: 'INR', billingCycle: 'monthly', description: '13 Pro templates, PDF and Word export, and the AI writing assistant.' }
];
...
const features = [
  ...
  { icon: Layers, title: 'Eleven free, thirteen Pro', copy: 'Start on Linen, Grove, Atlas, and eight more. Aurora, Ledger, Noir, and the other gold-framed layouts unlock when you subscribe.', tone: 'green' },
        ...
        <Container maxWidth="lg">
          <Stack direction={{ xs: 'column', sm: 'row' }} justifyContent="space-between" spacing={2}>
            ...
            <Stack direction="row" spacing={{ xs: 2, sm: 5 }}>
              <Box><strong>11</strong><span>free layouts</span></Box>
              <Box><strong>13</strong><span>Pro layouts</span></Box>
